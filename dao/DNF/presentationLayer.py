...
from dao.DNF.applicationLayer import get_installed_details, get_update_list
from model.Package import Package
from model.Update import Update
from dao.Shell import Shell

from common.costants import GET_UPDATE_DETAILS
...
class DNF:
        def get_update_partitions(self) -> dict:
                ...
                updates_details: list[Update] = get_update_details(update_list)
                installed_details: dict[str, Package] = get_installed_details(updates_details)
                partitions:dict = group_updates_by_partitions(updates_details, installed_details)
                                
                return partitions


def group_updates_by_partitions(updates_details, installed_details):
        partition_index = {}
